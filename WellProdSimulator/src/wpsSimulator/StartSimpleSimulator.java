...
import wpsPeasant.Utils.PeasantPurposeType;
...
public class StartSimpleSimulator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SocietyAgent societyAgent = new SocietyAgent(aliasSocietyAgent, societyAgentState, societyAgentStruct, 0.91);

            // Simulation Start
            startAllAgents(peasant, worldAgent, societyAgent);
    ...
    private static void startAllAgents(AgentBESA... A) throws ExceptionBESA {
        ...
        AdmBESA adm = AdmBESA.getInstance();
        PeriodicDataBESA data = new PeriodicDataBESA(500, PeriodicGuardBESA.START_PERIODIC_CALL);
