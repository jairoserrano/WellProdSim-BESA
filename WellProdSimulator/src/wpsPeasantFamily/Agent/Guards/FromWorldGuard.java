        ...
        try {
            ...
            switch (messageType) {
                case NOTIFY_CROP_DISEASE:
                    ...
                    break;
                case CROP_PESTICIDE:
                    believes.getPeasantProfile().setCurrentCropCare(CropCareType.PESTICIDE);
                    //wpsReport.info("   🍙🤖   PESTICIDAAAAA  🤖 🍙  ");
                    break;
                case NOTIFY_CROP_WATER_STRESS:
                    believes.getPeasantProfile().setCurrentCropCare(CropCareType.IRRIGATION);
                    break;
                ...
                case NOTIFY_CROP_READY_HARVEST:
                    believes.getPeasantProfile().setCurrentSeason(SeasonType.HARVEST);
                    break;
