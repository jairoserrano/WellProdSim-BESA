...
public class PeasantAgroGoal extends GoalBDI {
    ...
    public static PeasantAgroGoal buildGoal() {
        ...
        PeasantAgroGoal b = new PeasantAgroGoal(StartSimpleSimulator.getPlanID(), peasantFarmingRole, descrip, GoalBDITypes.SURVIVAL);
        return b;
    }

    public PeasantAgroGoal(long id, RationalRole role, String description, GoalBDITypes type) {
        super(id, role, description, type);
        ReportBESA.info("Meta PeasantAgroGoal created");
    }
    ...
    public boolean predictResultUnlegality(StateBDI agentStatus) throws KernellAgentEventExceptionBESA {
        ReportBESA.info("Meta PeasantAgroGoal predictResultUnlegability");
        return true;
    }
