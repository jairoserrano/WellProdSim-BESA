 ...
 * ==========================================================================
 */
package wpsPeasant.L4SkillsResourcesGoals;

import wpsPeasant.Tasks.ObtainSuppliesTask;
 ...
 * @author jairo
 */
public class ObtainingPesticidesGoal extends GoalBDI {

    /**
     *
     * @return
     */
    public static ObtainingPesticidesGoal buildGoal() {
        ...
        RationalRole obtainSuppliesRole = new RationalRole(
                "obtainSuppliesTask",
                obtainSuppliesPlan);
        ObtainingPesticidesGoal obtainSuppliesGoalBDI = new ObtainingPesticidesGoal(
                wpsStart.getPlanID(),
                obtainSuppliesRole,
                "obtainSuppliesTask",
     ...
     * @param type
     */
    public ObtainingPesticidesGoal(long id, RationalRole role, String description, GoalBDITypes type) {
