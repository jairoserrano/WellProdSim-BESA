 ...
 * @author jairo
 */
public class ObtainSuppliesGoalBDI extends GoalBDI {

    /**
     *
     * @return
     */
    public static ObtainSuppliesGoalBDI buildGoal() {
        ...
        RationalRole obtainSuppliesRole = new RationalRole(
                "obtainSuppliesTask",
                obtainSuppliesPlan);
        ObtainSuppliesGoalBDI obtainSuppliesGoalBDI = new ObtainSuppliesGoalBDI(
     ...
     * @param type
     */
    public ObtainSuppliesGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
