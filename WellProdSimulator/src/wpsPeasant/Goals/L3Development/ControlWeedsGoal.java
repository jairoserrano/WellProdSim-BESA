...
import wpsPeasant.Tasks.L3Development.ControlWeedsTask;
 ...
 * @author jairo
 */
public class ControlWeedsGoal extends GoalBDI {

    /**
     *
     * @return
     */
    public static ControlWeedsGoal buildGoal() {
        ...
        RationalRole controlWeedsRole = new RationalRole(
                "controlWeedsTask",
                controlWeedsPlan);
        ControlWeedsGoal controlWeedsGoalBDI = new ControlWeedsGoal(
                wpsStart.getPlanID(),
                controlWeedsRole,
                "controlWeedsTask",
     ...
     * @param type
     */
    public ControlWeedsGoal(long id, RationalRole role, String description, GoalBDITypes type) {
    ...
    public double detectGoal(Believes parameters) throws KernellAgentEventExceptionBESA {
        PeasantBDIAgentBelieves believes = (PeasantBDIAgentBelieves) parameters;
        ReportBESA.info("getCropHealth=" + believes.getPeasantProfile().getCropHealth());
        //@TODO: Incluir maleza
