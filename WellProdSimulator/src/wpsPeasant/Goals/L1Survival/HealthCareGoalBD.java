 ...
 * @author jairo
 */
public class HealthCareGoalBD extends GoalBDI {

    /**
     *
     * @return
     */
    public static HealthCareGoalBD buildGoal() {
        HealthCareTask healthCareTask = new HealthCareTask();
        Plan healthCarePlan = new Plan();
        healthCarePlan.addTask(healthCareTask);
        RationalRole healthCareRole = new RationalRole(
                "healthCareTask",
                healthCarePlan);
        HealthCareGoalBD healthCareGoalBDI = new HealthCareGoalBD(
                wpsControl.getPlanID(),
                healthCareRole,
                "healthCareTask",
                GoalBDITypes.SURVIVAL);
        return healthCareGoalBDI;
    }
     ...
     * @param type
     */
    public HealthCareGoalBD(long id, RationalRole role, String description, GoalBDITypes type) {
