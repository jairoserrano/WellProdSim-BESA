...
import wpsPeasant.Tasks.ManagePestsTask;
 ...
 * @author jairo
 */
public class ManagePestsGoalBDI extends GoalBDI {

    /**
     *
     * @return
     */
    public static ManagePestsGoalBDI buildGoal() {
        ...
        RationalRole managePestsRole = new RationalRole(
                "managePestsTask",
                managePestsPlan);
        ManagePestsGoalBDI managePestsGoalBDI = new ManagePestsGoalBDI(
     ...
     * @param type
     */
    public ManagePestsGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
