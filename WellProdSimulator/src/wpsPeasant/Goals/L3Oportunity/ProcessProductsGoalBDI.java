 ...
 * @author jairo
 */
public class ProcessProductsGoalBDI extends GoalBDI {

    /**
     *
     * @return
     */
    public static ProcessProductsGoalBDI buildGoal() {
        ...
        RationalRole processProductsRole = new RationalRole(
                "processProductsTask",
                processProductsPlan);
        ProcessProductsGoalBDI processProductsGoalBDI = new ProcessProductsGoalBDI(
     ...
     * @param type
     */
    public ProcessProductsGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
