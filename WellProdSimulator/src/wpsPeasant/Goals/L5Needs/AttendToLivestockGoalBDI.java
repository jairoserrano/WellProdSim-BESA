 ...
 * @author jairo
 */
public class AttendToLivestockGoalBDI extends GoalBDI {
    ...
    public static AttendToLivestockGoalBDI buildGoal() {
        ...
        AttendToLivestockGoalBDI attendToLivestockGoalBDI = new AttendToLivestockGoalBDI(
                wpsControl.getPlanID(),
                attendToLivestockRole,
                "attendToLivestockTask",
                GoalBDITypes.NEED);
        return attendToLivestockGoalBDI;
    }
     ...
     * @param type
     */
    public AttendToLivestockGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
