 ...
 * @author jairo
 */
public class CollaborateGoalBDI extends GoalBDI {

    /**
     *
     * @return
     */
    public static CollaborateGoalBDI buildGoal() {
        CollaborateTask collaborateTask = new CollaborateTask();
        Plan collaboratePlan = new Plan();
        collaboratePlan.addTask(collaborateTask);
        RationalRole collaborateRole = new RationalRole(
                "collaborateTask",
                collaboratePlan);
        CollaborateGoalBDI collaborateGoalBDI = new CollaborateGoalBDI(
