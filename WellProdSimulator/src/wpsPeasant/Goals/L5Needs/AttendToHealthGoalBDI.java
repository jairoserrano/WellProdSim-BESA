 ...
 * @author jairo
 */
public class AttendToHealthGoalBDI extends GoalBDI {

    /**
     *
     * @return
     */
    public static AttendToHealthGoalBDI buildGoal() {
        AttendToHealthTask attendToHealthTask = new AttendToHealthTask();
        Plan attendToHealthPlan = new Plan();
        attendToHealthPlan.addTask(attendToHealthTask);
        RationalRole attendToHealthRole = new RationalRole(
                "attendToHealthTask",
                attendToHealthPlan);
        AttendToHealthGoalBDI attendToHealthGoalBDI = new AttendToHealthGoalBDI(
                wpsControl.getPlanID(),
                attendToHealthRole,
                "attendToHealthTask",
                GoalBDITypes.NEED);
        return attendToHealthGoalBDI;
    }
     ...
     * @param type
     */
    public AttendToHealthGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
