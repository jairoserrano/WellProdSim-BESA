 ...
 * @author jairo
 */
public class AskForCollaborationGoalBDI extends GoalBDI {

    /**
     *
     * @return
     */
    public static AskForCollaborationGoalBDI buildGoal() {
        AskForCollaborationTask askForCollaborationTask = new AskForCollaborationTask();
        ...
        AskForCollaborationGoalBDI askForCollaborationGoalBDI = new AskForCollaborationGoalBDI(
     ...
     * @param type
     */
    public AskForCollaborationGoalBDI(long id, RationalRole role, String description, GoalBDITypes type) {
