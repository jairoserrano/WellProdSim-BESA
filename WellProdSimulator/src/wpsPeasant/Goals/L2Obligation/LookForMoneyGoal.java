 ...
 * ==========================================================================
 */
package wpsPeasant.Goals.L2Obligation;

import wpsPeasant.Tasks.L3Development.GenerateIncomeTask;
...
public class LookForMoneyGoal extends GoalBDI {
     ...
     * @param type
     */
    public LookForMoneyGoal(long id, RationalRole role, String description, GoalBDITypes type) {
